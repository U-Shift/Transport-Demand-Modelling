...
> **Note:** I used other functions for summary statistics compared to the MLR chapter. R allows you to do the same or similar tasks with different packages. 
...
> **Note:** Check the cummulative variance of first components and the scree plot, and see if the PCA is good approach to detect the number of factors in this case. 
