...
> **Note**: The listwise deletion removes the whole observation that has a missing value from the analysis. This may be appropriate only in some cases. There are many other forms of treating missing values. Take a look for yourselves. 
...
> **Note:** There are many methods to treat outliers. This is just one of them. Not an ideal one, since it removes many observations that are relevant for the analysis, since the dataset is small.  
