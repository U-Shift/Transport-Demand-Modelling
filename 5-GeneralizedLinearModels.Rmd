...
> **Note:** AADT1 does not have a value because it is the offset of the model. Additionally, the variable STATE also does not have a value because it is a categorical variable. In this case it would be needed to calculate the pseudo-elasticity. 
