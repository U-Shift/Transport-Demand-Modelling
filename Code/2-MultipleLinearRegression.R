...
#'    It measures the proportion of an area to which minority groups (e.g: non-whites, foreign-born, Eastern Europeans) 
#'    live in isolation.
#'      (_**Note:** High values for this index imply that those communities are less prone to leaving their living areas and
#'       as such to having lower levels of mobility_)
#' 
#' ## Let's begin!
#' 
#' ##### Import Libraries
...
#' 
#' Although `TODU` is a continuous variable, the small sample size (n=57) makes it likely to have repeated values. 
