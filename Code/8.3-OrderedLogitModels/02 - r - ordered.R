...
####Determine variables 
#####lhs variables
dat$CHOICE_ORD<- as.factor(data_3lev$CHOICE_ORD)
dat$CHOICE_ORD <- as.ordered(data_3lev$ CHOICE_ORD)

#####rhs variables
data_3lev$CAPOTA <- as.factor(data_3lev$CAPOTA)
data_3lev$WINTER <- as.factor(data_3lev$WINTER)
data_3lev$GENDER <- as.factor(data_3lev$GENDER)
data_3lev$ACDIR <- as.factor(data_3lev$ACDIR)
data_3lev$VEIC1 <- as.factor(data_3lev$VEIC1)
data_3lev$PEAK1820 <- as.factor(data_3lev$PEAK1820)
data_3lev$AGE32 <- as.factor(data_3lev$AGE32)
data_3lev$AGE21 <- as.factor(data_3lev$AGE21)
data_3lev$AGE23 <- as.factor(data_3lev$AGE23)
data_3lev$AGE26 <- as.factor(data_3lev$AGE26)
data_3lev$VALETA <- as.factor(data_3lev$VALETA)
data_3lev$AGE <- as.integer(data_3lev$AGE)
data_3lev$NOCUP <- as.integer(data_3lev$NOCUP)
data_3lev$LVEL <- as.numeric(data_3lev$LVEL)
...
round(digits=3,margeff(fit1))
round(digits=3,margeff(fit2))
