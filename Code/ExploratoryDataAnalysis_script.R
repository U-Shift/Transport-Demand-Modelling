...
# `SRI`: Social Rank Index:  
      ...
      # 2. proportion of people with age higher than 25 years that have completed at least 8 year of education;
        # (Note: The SRI has its maximum value when there are no blue-collar workers and all adults have 
        # education of at least 8 years)

# `UI`: Urbanization Index:  
      # 1. fertility rate, defined as the ratio of children under 5 years of age to  the female 
