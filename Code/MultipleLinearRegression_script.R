...
# TODU: Motorized Trips (private car or Public Transportation) per occupied
# dwelling unit
...
# SRI: Social Rank Index:
    ...
    ### Note: The SRI has its maximum value when there are no blue-collar  
    ### workers and all adults have education of at least 8 years. 
...
library(tidyverse) 
# Library used for providing a summary of the data
library(skimr) 
# Library used in data science to perform exploratory data analysis
library(DataExplorer)
# Library used for correlation plots
library(corrplot)
# Library used for testing autocorrelation (Durbin Watson)
library(car)
# Library used for testing multicollinearity (VIF, TOL, etc.)
library(olsrr)
# Library used for pairwise comparisions between variables
library(ggplot2)
# Library used pairwise comparisions between variables
library(lattice)
...
# Or you could just run this code with the file path. 
setwd("G:/Meu Drive/TDM - Lecture R/Multiple Linear Regression")
