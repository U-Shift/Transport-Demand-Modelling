...
**Reference:** Washington, Simon P., Karlaftis, Mathew G. e Mannering
(2003) Statistical and econometric Methods for Transportation Data
Analysis, CRC
...
```
    ...
    ## tibble[,6] [84 x 6] (S3: tbl_df/tbl/data.frame)
...
Estimate goodness of fit parameters for the PDF of ACCIDENT.This test
analyses the equality between the mean and the variance through Poisson
Regression Standard against the alternative of the variance exceeding
the mean (Negative Binomial).
